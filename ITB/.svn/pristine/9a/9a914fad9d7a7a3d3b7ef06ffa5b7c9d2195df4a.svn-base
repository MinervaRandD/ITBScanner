...
#End Region
        ...
        Public Sub Trace(ByVal TheHost As String, ByVal TheTimeoutMS As Integer)
            ...
            Try
                'MyIpAddress = System.Net.Dns.Resolve(TheHost).AddressList(0) 'AP-082109 obsolete
                MyIpAddress = System.Net.Dns.GetHostEntry(TheHost).AddressList(0)
        ...
        Public Function GetNextTraceResponse(ByVal TheAttemptCount As Integer) As TraceResponse
            ...
            If TR.IPAddress Is Nothing = False Then
                ...
                Try
                    'TR.HostName = System.Net.Dns.GetHostByAddress(TR.IPAddress) 'AP-082109 obsolete
                    TR.HostName = System.Net.Dns.GetHostEntry(TR.IPAddress)
                Catch ex As Exception
                End Try
        ...
        Public Function GetNextTraceResponse() As TraceResponse
            Return GetNextTraceResponse(3) 'AP-082109
        End Function
