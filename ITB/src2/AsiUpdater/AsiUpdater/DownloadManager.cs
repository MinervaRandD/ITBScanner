...
namespace AsiUpdater
{
    public class DownloadManager : IDisposable
    {
        ...
        public void StartDownload(UpgradeAvailableEventArgs e)
        {
            ...
            try            
            {
                ...
                foreach (Data.DownloadFile chunk in DF)
                {
                    ...
                    try
                    {
                        ...
                        string JsonRequest = dlreq.ToJsonString();

                        HttpWebReq = (HttpWebRequest)HttpWebRequest.Create(uri);
                        HttpWebReq.Method = "POST";
                        HttpWebReq.ContentLength = JsonRequest.Length;
                        ...
                        ReqStreamWriter.Write(JsonRequest);
