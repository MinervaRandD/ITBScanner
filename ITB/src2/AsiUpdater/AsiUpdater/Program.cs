...
namespace AsiUpdater
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            Data.File file = new AsiUpdater.Data.File()
            {
                FileName = "Itb.cab",
                Type = "cab",
                Size = 10000,
            ...
            List<Data.File> fileList = new List<AsiUpdater.Data.File>() { file };

            UpgradeAvailableEventArgs args = new UpgradeAvailableEventArgs()
            {
                UpgradeFiles = fileList
            };

            DownloadMgr = new DownloadManager();
            DownloadMgr.StartDownload(args);
#endif
        }        
