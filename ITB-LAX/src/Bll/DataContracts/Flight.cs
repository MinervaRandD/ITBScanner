    ...
    public class Flight
    {
        ...
        public string ArrivalTimeXml
        {
            get
            {
                ...
                {
                    return this.ArrivalTime.Value.ToString("s");
                }
            }
            set
            {
                this.ArrivalTime = DateTime.ParseExact(value, "s", null);
            }
        }
        ...
        public string DepartureTimeXml
        {
            get
            {
                ...
                {
                    return this.DepartureTime.Value.ToString("s");
                }
            }
            set
            {
                this.DepartureTime = DateTime.ParseExact(value, "s", null);
            }
        }
    }
}
