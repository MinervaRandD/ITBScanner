Module PasswordGenerator
    ...
    Public Function genLoginPassword(ByVal passwordSeed As String) As String
        ...
        For i = 0 To 9
            ...
            Dim offset As Integer = getPasswordStringValue(passwordSeed.Substring(i + 4, 4))
    ...
    'Added by MX for complete configuration
    Public Function genCompleteConfigPassword(ByVal passwordSeed As String) As String
        ...
        For i = 0 To 9
            ...
            Dim offset As Integer = getPasswordStringValue(passwordSeed.Substring(i + 5, 4))
