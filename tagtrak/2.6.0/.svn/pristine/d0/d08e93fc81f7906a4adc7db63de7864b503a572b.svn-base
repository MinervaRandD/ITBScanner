...
AIRLINESOFTWARE_API void Code128Active()
{
	...
	*/
	IS9CConfig *pS9CConfig;
	HRESULT hrStatus ;
	hrStatus = ITCDeviceOpen( TEXT("default"), IID_IS9CConfig, ITC_DHDEVFLAG_NODATA, (LPVOID *) &pS9CConfig );
	hrStatus = pS9CConfig->SetCode128(ITC_CODE128_ACTIVE ,ITC_EAN128_ID_REMOVE,
		ITC_CODE128_CIP128_NO_CHANGE,ITC_CODE128_FNC1_NO_CHANGE,ITC_BC_LENGTH_NO_CHANGE );  
    ITCDeviceClose( (IUnknown **) &pS9CConfig );
}
...
AIRLINESOFTWARE_API int fnTest10(int value)
{
	return value;
}
