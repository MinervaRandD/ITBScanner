...
Public Class baggageRecordClass
    ...
    Public Sub New(ByVal baggageRecord As baggageRecordClass)
    ...
    Public Function formatNormal() As String
        ...
        returnString &= createFixedWidthField(baggageLocation, 3, " ")
        returnString &= " "
        returnString &= scanDateString
        returnString &= scanTimeString
        returnString &= createFixedWidthField(baggageTagID, 12, " ")
        returnString &= " "
        returnString &= createFixedWidthField(baggageFlightNumber, -4, " ")
        returnString &= "  "
        returnString &= "   "
        returnString &= createFixedWidthField(baggageACBinID, 6, " ")
        returnString &= createFixedWidthField(baggageCarrierCode, 2, " ")
        returnString &= createFixedWidthField(baggageHoldPosition, 6, " ")
        returnString &= createFixedWidthField(baggageContainerPosition, 10, " ")
