...
#End If
    ...
    Private Sub setupFormKeyboard()
        ...
        Dim textBoxCollection()() As System.windows.forms.TextBox = {  mailScanTextBoxCollection,  mailScanSimpleTextBoxCollection}
    ...
    Friend WithEvents flightStatusPictureBox As System.Windows.Forms.PictureBox
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(MailScanBaseForm))
        ...
        Me.flightStatusPictureBox = New System.Windows.Forms.PictureBox
        '
        'mainTabControl
        '
        ...
        'MailScanTab
        '
        Me.MailScanTab.Controls.Add(Me.flightStatusPictureBox)
        Me.MailScanTab.Controls.Add(Me.binFullButton)
        Me.MailScanTab.Controls.Add(Me.counterIcon)
        Me.MailScanTab.Controls.Add(Me.Label13)
        Me.MailScanTab.Controls.Add(Me.code93LockedPictureBox)
        Me.MailScanTab.Controls.Add(Me.mailLocationComboBox)
        Me.MailScanTab.Controls.Add(Me.enableCode93CheckBox)
        Me.MailScanTab.Controls.Add(Me.mailLocationLabel)
        ...
        Me.MailScanTab.Controls.Add(Me.tailNumberLabel)
        Me.MailScanTab.Controls.Add(Me.tailNumberTextBox)
        ...
        Me.MailScanTab.Controls.Add(Me.rejectReasonTextBox)
        ...
        Me.MailScanTab.Controls.Add(Me.rejectReasonLabel)
        ...
        Me.MailScanTab.Controls.Add(Me.summaryButton)
        Me.MailScanTab.Controls.Add(Me.presetButton)
        Me.MailScanTab.Controls.Add(Me.binUploadButton)
        Me.MailScanTab.Controls.Add(Me.binChangeButton)
        Me.MailScanTab.Controls.Add(Me.manifestButton)
        Me.MailScanTab.Controls.Add(Me.uploadButton)
        Me.MailScanTab.Location = New System.Drawing.Point(4, 4)
        Me.MailScanTab.Size = New System.Drawing.Size(245, 302)
        ...
        'operationComboBox
        '
        Me.operationComboBox.Font = New System.Drawing.Font("Tahoma", 9.0!, System.Drawing.FontStyle.Regular)
        ...
        Me.operationComboBox.Location = New System.Drawing.Point(95, 36)
        Me.operationComboBox.Size = New System.Drawing.Size(146, 22)
        '
        'groupNumberTextBox
        '
        Me.groupNumberTextBox.Location = New System.Drawing.Point(169, 81)
        ...
        Me.mailDestinationComboBox.Location = New System.Drawing.Point(189, 122)
        ...
        Me.flightNumberTextBox.Text = "1234"
        '
        'Label3
        '
        ...
        'weightTextBox
        '
        Me.weightTextBox.Location = New System.Drawing.Point(109, 81)
        ...
        'transferPointLabel
        '
        Me.transferPointLabel.Location = New System.Drawing.Point(3, 147)
        ...
        'Label7
        '
        Me.Label7.Location = New System.Drawing.Point(72, 104)
        ...
        'destinationLabel
        '
        Me.destinationLabel.Location = New System.Drawing.Point(193, 104)
        ...
        '
        '
        'flightStatusPictureBox
        '
        Me.flightStatusPictureBox.Image = CType(resources.GetObject("flightStatusPictureBox.Image"), System.Drawing.Image)
        Me.flightStatusPictureBox.Location = New System.Drawing.Point(154, 116)
        Me.flightStatusPictureBox.Size = New System.Drawing.Size(27, 27)
        '
        'MailScanBaseForm
        '
...
#End If
    ...
    Public Sub HandleMailScanData(ByRef readerString As String, ByVal symbology As Integer)
        ...
        If enableCode93CheckBox.Checked Then
            ...
            If Length(readerString) = 10 Then
                ...
                Me.DialogResult = MailScanFormRepository.MailScanGetWeightForm.ShowDialog()
    ...
    Public Sub HandleCargoScanData(ByVal readerString As String, ByVal symbology As Integer)
        ...
        cargoScanFormRepository.CargoScanBaseForm.ShowDialog()
...
#End If
    ...
    Private Sub handleUploadButtonClick()
        ...
        If newConfigurationFileFound Then
            ...
            Dim localBinFilePath As String = TagTrakConfigDirectory & "\ScannerConfig.bin"
...
#End If
    ...
    Private Sub summaryButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles summaryButton.Click
        ...
        Me.DialogResult = MailScanFormRepository.MailScanManifestSummaryForm.ShowDialog
...
#End If
    ...
    Private Sub changeBin_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles binChangeButton.Click
        ...
        Me.DialogResult = MailScanFormRepository.MailScanBinChangeForm.ShowDialog()
        If Me.DialogResult = DialogResult.Abort Then Me.Close()
    ...
    Private Sub binUploadButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles binUploadButton.Click
        ...
        Me.DialogResult = MailScanFormRepository.MailScanBinUploadForm.ShowDialog()
        If Me.DialogResult = DialogResult.Abort Then Me.Close()
    ...
    Private Sub manifestButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles manifestButton.Click
        ...
        Me.DialogResult = MailScanFormRepository.MailScanManifestForm.ShowDialog()
        If Me.DialogResult = DialogResult.Abort Then Me.Close()
    ...
    Private Sub counterIcon_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles counterIcon.Click
    ...
    Private Sub setupMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles setupMenuItem.Click
        ...
        Me.DialogResult = tagTrakFormRepository.tagTrakTagTrakSetupMenuForm.ShowDialog()
        If Me.DialogResult = DialogResult.Abort Then Me.Close()
    ...
    Private Sub messagesMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles messagesMenuItem.Click
        ...
        Me.DialogResult = tagTrakFormRepository.tagTrakMessageForm.ShowDialog()
        If Me.DialogResult = DialogResult.Abort Then Me.Close()
    ...
    Private Sub cargoOpsMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cargoOpsMenuItem.Click
        ...
        Me.DialogResult = cargoScanFormRepository.CargoScanBaseForm.ShowDialog()
        If Me.DialogResult = DialogResult.Abort Then Me.Close()
    ...
    Private Sub presetButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles presetButton.Click
        ...
        Me.DialogResult = MailScanFormRepository.MailScanPresetsForm.ShowDialog()
        If Me.DialogResult = DialogResult.Abort Then Me.Close()
    ...
    '    messageFormLogoPath = TagTrakConfigDirectory & "\" & userSpecRecord.userName & "scanFormLogo.bmp"
    ...
    '    messageFormLogoPath = TagTrakConfigDirectory & "\scanFormLogo.bmp"
    ...
    '    baggageFormLogoPath = TagTrakConfigDirectory & "\" & userSpecRecord.userName & "scanFormLogo.bmp"
    ...
    '    baggageFormLogoPath = TagTrakConfigDirectory & "\scanFormLogo.bmp"
    ...
    Private Sub binFullButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles binFullButton.Click
        ...
        Me.DialogResult = MailScanFormRepository.MailScanCreateNewPresetForm.ShowDialog
        If Me.DialogResult = DialogResult.Abort Then
            Me.Close()
            Exit Sub
        End If
...
#End If
    ...
    Private Sub flightStatusPictureBox_ParentChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles flightStatusPictureBox.Click

        Dim arriveFlightList As New ArrayList
        Dim departFlightList As New ArrayList

        Dim flightRecord As flightRecordClass

        For Each flightRecord In flightRecordSet.Values

            If flightRecord.isInboundFlight Then arriveFlightList.Add(flightRecord.flightNumber.ToString.PadLeft(4, "0"c))
            If flightRecord.isOutboundFlight Then departFlightList.Add(flightRecord.flightNumber.ToString.PadLeft(4, "0"c))

        Next

        arriveFlightList.Sort()
        departFlightList.Sort()

        MailScanFormRepository.MailScanFlightStatusMessageForm.init(arriveFlightList, departFlightList)

        Me.DialogResult = MailScanFormRepository.MailScanFlightStatusMessageForm.ShowDialog()
        If Me.DialogResult = DialogResult.Abort Then Me.Close()
