...
Namespace Test
    ...
    Public Class NetworkSettings
        ...
        Protected Overrides Sub StartTestThread()
            Dim DetailsBuilder As New Text.StringBuilder
        ...
        Private Function TestAdapter(ByVal TheAdapter As Adapter, ByVal TheDetailsBuilder As Text.StringBuilder) As Results
            With TheAdapter
                '' Write log file
        ...
        Private Function IsIPValid(ByVal TheIp As String) As Boolean
            Try
                If System.Net.IPAddress.Parse(TheIp).Address <> 0 Then Return True
            Catch ex As Exception
                Return False
            End Try
            Return False
        ...
        Private Function TestConnection(ByVal TheConnectionMan As ConnectionManager, ByVal TheDetailsBuilder As Text.StringBuilder) As Results
            '' Write log file
        ...
        Private Function TestConnections(ByVal TheConnectionMan As ConnectionManager, ByVal TheDetailsBuilder As Text.StringBuilder) As Results
        ...
        Private Function TestRegistry(ByVal TheDetailsBuilder As Text.StringBuilder) As Results
            '' Write log file
