}

static UINT8 key_parm[_MAX_KEY_COLUMNS][4] ;

static UINT8 S[256] ;

void initS()
{
	UINT8 init_vec[256] = { 99, 124, 119, 123, 242, 107, 111, 197,  48,   1, 103,  43, 254, 215, 171, 118, 
	...
	for ( int i = 0 ; i < 256 ; i++ ) S[i] = init_vec[i] ;
}
 ...
 void initT1()
{
	...
	for ( int i = 0 ; i < 256 ; i++) for ( int j = 0 ; j < 4 ; j++ ) { T1[i][j] = init_vec[k] ; k++ ; }
...
void initT2()
{
  ...
  int k = 0 ; for ( int i = 0 ; i < 256 ; i++ ) for ( int j = 0 ; j < 4 ; j++ ) { T2[i][j] = init_vec[k] ; k++ ; }
}
...
void initT3()
{
  ...
  int k = 0 ; for ( int i = 0 ; i < 256 ; i++ ) for ( int j = 0 ; j < 4 ; j++ ) { T3[i][j] = init_vec[k] ; k++ ; }
}
...
void initT4()
{
  ...
  int k = 0 ; for ( int i = 0 ; i < 256 ; i++ ) for ( int j = 0 ; j < 4 ; j++ ) { T4[i][j] = init_vec[k] ; k++ ; }
}
...
void initT5()
{
  ...
  int k = 0 ; for ( int i = 0 ; i < 256 ; i++ ) for ( int j = 0 ; j < 4 ; j++ ) { T5[i][j] = init_vec[k] ; k++ ; }
}
...
void initT6()
{
  ...
  int k = 0 ; for ( int i = 0 ; i < 256 ; i++ ) for ( int j = 0 ; j < 4 ; j++ ) { T6[i][j] = init_vec[k] ; k++ ; }
}
...
void initT7()
{
  ...
  int k = 0 ; for ( int i = 0 ; i < 256 ; i++ ) for ( int j = 0 ; j < 4 ; j++ ) { T7[i][j] = init_vec[k] ; k++ ; }
}
...
void initT8()
{
  ...
  int k = 0 ; for ( int i = 0 ; i < 256 ; i++ ) for ( int j = 0 ; j < 4 ; j++ ) { T8[i][j] = init_vec[k] ; k++ ; }
}
...
void initS5()
{
  ...
  for ( int i = 0 ; i < 256 ; i++ ) S5[i] = init_vec[i] ;
}
...
void initU1()
{
  ...
  int k = 0 ; for ( int i = 0 ; i < 256 ; i++ ) for ( int j = 0 ; j < 4 ; j++ ) { U1[i][j] = init_vec[k] ; k++ ; }
}
...
void initU2()
{
  ...
  int k = 0 ; for ( int i = 0 ; i < 256 ; i++ ) for ( int j = 0 ; j < 4 ; j++ ) { U2[i][j] = init_vec[k] ; k++ ; }
}
...
void initU3()
{
  ...
  int k = 0 ; for ( int i = 0 ; i < 256 ; i++ ) for ( int j = 0 ; j < 4 ; j++ ) { U3[i][j] = init_vec[k] ; k++ ; }
}
...
void initU4()
{
  ...
  int k = 0 ; for ( int i = 0 ; i < 256 ; i++ ) for ( int j = 0 ; j < 4 ; j++ ) { U4[i][j] = init_vec[k] ; k++ ; }
}
...
{ 
  ...
  for ( int i = 0 ; i < 30; i++ ) rcon[i] = init_vec[i] ;
}
...
int Rijndael::init(Mode mode,Direction dir,const UINT8 * key,KeyLength keyLen,UINT8 * initVector)
{
	...
	// Check the mode
	if((mode != Mode_CBC) && (mode != Mode_ECB) && (mode != Mode_CFB1))return RIJNDAEL_UNSUPPORTED_MODE;
	m_mode = mode;

	// And the direction
	if((dir != Direction_Encrypt) && (dir != Direction_Decrypt))return RIJNDAEL_UNSUPPORTED_DIRECTION;
	m_direction = dir;
	...
	switch(keyLen)
	{
		case KeyLength16Bytes:
			uKeyLenInBytes = 16;
			m_uRounds = 10;
		break;
		case KeyLength24Bytes:
			uKeyLenInBytes = 24;
			m_uRounds = 12;
		break;
		case KeyLength32Bytes:
			uKeyLenInBytes = 32;
			m_uRounds = 14;
		break;
		default:
	...
	for ( int i1 = 0 ; i1 < _MAX_KEY_COLUMNS ; i1++ )
	{
		for ( int i2 = 0 ; i2 < 4 ; i2++ ) key_parm[i1][i2] = keyMatrix[i1][i2] ;
	}

	keySched();

	if(m_direction == Direction_Decrypt)keyEncToDec();
...
int Rijndael::blockEncrypt(const UINT8 *input,int inputLen,UINT8 *outBuffer)
{
	...
	if(m_state != State_Valid)return RIJNDAEL_NOT_INITIALIZED;
	if(m_direction != Direction_Encrypt)return RIJNDAEL_BAD_DIRECTION;
...
int Rijndael::padEncrypt(const UINT8 *input, int inputOctets, UINT8 *outBuffer)
{
	...
	if(m_state != State_Valid)return RIJNDAEL_NOT_INITIALIZED;
	if(m_direction != Direction_Encrypt)return RIJNDAEL_NOT_INITIALIZED;
...
int Rijndael::blockDecrypt(const UINT8 *input, int inputLen, UINT8 *outBuffer)
{
	...
	if(m_state != State_Valid)return RIJNDAEL_NOT_INITIALIZED;
	if((m_mode != Mode_CFB1) && (m_direction == Direction_Encrypt))return RIJNDAEL_BAD_DIRECTION;
...
int Rijndael::padDecrypt(const UINT8 *input, int inputOctets, UINT8 *outBuffer)
{
	...
	if(m_state != State_Valid)return RIJNDAEL_NOT_INITIALIZED;
	if(m_direction != Direction_Decrypt)return RIJNDAEL_BAD_DIRECTION;
...
void Rijndael::keySched()
{
	...
	{
		*((UINT32*)(tempKey[j])) = *((UINT32*)(key_parm[j]));
	}
...
void Rijndael::encrypt(const UINT8 *a, UINT8 *b)
{
	unsigned int r;
	UINT8 temp[4][4];

	int x1 = (int) m_expandedKey[0][0] ;
	int x2 = (int) T1[0][0] ;
	int x3 = (int) T2[0][0] ;
	int x4 = (int) T3[0][0] ;
...
void Rijndael::decrypt(const UINT8 a[16], UINT8 b[16])
{
	...
	*((UINT32*)(b+12)) ^= *((UINT32*)m_expandedKey[0][3]);
	...
	void Rijndael::BuildKey(int keyIndex)
	{
		int j = keyIndex * 37 ;

		for ( int i = 0 ; i < 32 ; i++, j++ )
		{
			baseKey[i] = KeyBaseX[j % 1023] ;
		}
	}
 
	int Rijndael::aesEncrypt( const UINT8 *inputBuffer, const int inputLen, unsigned char *outputBuffer, int keyIndex)
	{	
		int rc ;

		Mode mode = Mode_CBC ;

		KeyLength keyLength = KeyLength32Bytes ;

		BuildKey(keyIndex) ;

		rc = init(mode, Direction_Encrypt, baseKey, keyLength, (UINT8 *) 0 ) ;

		if (rc < 0) return rc ;

		rc = padEncrypt(inputBuffer, inputLen, outputBuffer) ;

		return rc ;
	}

	int Rijndael::aesDecrypt( const UINT8 *inputBuffer, const int inputLen, unsigned char *outputBuffer, int keyIndex)
	{
		int rc ;
		...
		rc = init(mode, Direction_Decrypt, baseKey, keyLength, (UINT8 *) 0 ) ;

		if (rc < 0) return rc ;

		rc = padDecrypt(inputBuffer, inputLen, outputBuffer) ;
