...
Module bagScanTransaction
    ...
    Public baggageRecord As New bagRecordClass
    ...
    Private Function validateBaggageContainerPosition() As String
        ...
        If Not Util.isValidBaggageContainerPosition(transactionContainerPosition) Then
    ...
    Private Function validateBaggageHoldPosition() As String
        ...
        If Not Util.isValidBaggageHoldPosition(transactionHoldPosition) Then
    ...
    Public Function validateNonDuplicateBaggageTagID() As String
        ...
        If baggageRecordSet.ContainsKey(baggageRecordHashKey) Then
            ...
            Dim localbaggageRecord As bagRecordClass = baggageRecordSet.Item(baggageRecordHashKey)
        ...
        Else
            ...
            Dim newbaggageRecord As New bagRecordClass(baggageRecord)
    ...
    Public Function threadedSaveNewBaggageRecords(ByRef baggageRecord As bagRecordClass) As String
    ...
    Public Sub saveNewBaggageRecordsThread()
        ...
        Dim baggageRecord As bagRecordClass
    ...
    Public Function saveUpdatedBaggageScanCounts() As String
        ...
        Dim outputRecord As String = Trim(BagScanFormRepository.BagScanBaseForm.baggagePieceCountLabel.Text)
    ...
    Private Function setupAndConditionBaggageTransactionDataFromReaderForm() As String
        ...
        With BagScanFormRepository.BagScanBaseForm
            ...
            If isNonNullString(.tbxBagTagID.Text) Then
                transactionTagID = Trim(.tbxBagTagID.Text)
            Else
                transactionTagID = ""
            End If

            .tbxBagTagID.Text = transactionTagID
            ...
            'If isNonNullString(.lblBagScanLocation.Text) Then
            '    transactionLocation = Trim(.lblBagScanLocation.Text)
            'Else
            '    transactionLocation = ""
            'End If
            If isNonNullString(.cbxBagScanLocation.Text) Then
                transactionLocation = Trim(.cbxBagScanLocation.Text)
            Else
                transactionLocation = ""
            End If
            ...
            If isNonNullString(.baggageCarrierCodeLabel.Text) Then
                transactionCarrierCode = Trim(.baggageCarrierCodeLabel.Text)
            Else
    ...
    Public Function processBagScanData(ByVal bagScanBaseForm As BagScanBaseForm) As String
        ...
        If bagScanBaseForm Is Nothing Then
        ...
        BagScanFormRepository.BagScanBaseForm.baggagePieceCountLabel.Text += 1
