...
Public Class adminUploadFileForm
...
#If ValidationLevel >= 3 Then
        ...
        if diagnosticLevel >= 2 then
            verify(Not inputLocalFileName Is Nothing, 15)
            verify(Not inputLocalFilePath Is Nothing, 16)
            verify(Not inputRemoteFileName Is Nothing, 17)
            verify(Not inputRemoteFilePath Is Nothing, 18)
        End If
...
#End If
    ...
    Public Sub initAdminUploadFileForm(ByVal inputLocalFileName As String, ByVal inputLocalFilePath As String, ByVal inputRemoteFileName As String, ByVal inputRemoteFilePath As String)
        ...
        fileNameLabel.Text = "Uploading file '" & localFileName & "' to remote server"
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(adminUploadFileForm))
...
#End Region
    ...
    Private Sub ftpProcess_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If result <> "OK" Then
            MsgBox("Upload of file '" & localFileName & "' failed: " & result, MsgBoxStyle.Exclamation, "Upload of file failed.")
        End If
