Namespace Test.ToolBox
    ...
    Public Class Registry
        ...
        Private Sub AppendKey(ByVal TheSB As Text.StringBuilder, ByVal TheKey As Win32.RegistryKey, ByVal TheIndentCount As Integer)
        ...
        Private Sub AppendTabs(ByVal TheSB As Text.StringBuilder, ByVal TheNumber As Integer)
